...
const b = true, k = "mp-weixin", T = S([]), P = k, A = S('{\n    "address": [\n        "127.0.0.1",\n        "192.168.110.1",\n        "192.168.252.1",\n        "192.168.1.96",\n        "172.22.96.1"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "D:/360Downloads/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), E = S('[{"provider":"aliyun","spaceName":"project-store","spaceId":"mp-522be147-ff70-4eb0-ac74-c984a0f22131","clientSecret":"vnY5+N42LSswkwZgeKbfRw==","endpoint":"https://api.next.bspapp.com"}]') || [];
let x = "";
try {
  x = "__UNI__2511C6B";
} catch (e) {
